...
// import HostedForm from 'packages/hosted-form-v2/src/hosted-form';
// import HostedForm from 'packages/hosted-form-v2/src/hosted-form';

// import { MonerisPaymentInitializeOptions } from '.';
...
export default class MonerisPaymentStrategy {
    ...
    private async executeWithCC(payment: OrderPaymentRequestBody): Promise<void> {
        ...
        const nonce = await new Promise<string | undefined>((resolve, reject) => {
            ...
            const frameref = this.iframe.contentWindow;
    ...
    private async executeWithVaulted(
        ...
        if (this.hostedForm) {
            ...
            await form.submit(
                payment,
                this.paymentIntegrationService.handlePaymentHumanVerification,
                this.
            );
    ...
    private async mountCardVerificationfields(formOptions: HostedFormOptions): Promise<HostedForm> {
        ...
        const form = this.hostedFormFactory.create(bigpayBaseUrl, formOptions);
